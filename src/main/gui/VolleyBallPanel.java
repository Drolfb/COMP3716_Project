...
public class VolleyBallPanel extends JPanel {
    ...
    private String[] roles = {"Player", "Coach", "Referee", "Manager"};
    ...
    public void dropDownMenu(String[] options) {
        ...
        final JComboBox existingUserComboBox = new JComboBox();
        ...
        existingUserPanel.setPreferredSize(new Dimension(260,50));
        ...
        //existingUserPanel.add(existingPasswordLabel); not needed
        ...
        JLabel createUserLabel2;
        JButton createUserButton;

        createUserHeader = new JLabel("Don't see your name here?");
        JPanel createUserPanel = new JPanel();
        createUserPanel.setPreferredSize(new Dimension(260,100));
        createUserHeader.setFont(new Font("Georgia", Font.BOLD, 16));
        createUserLabel = new JLabel("Username:   ");
        createUserButton = new JButton("Create User!");
        createUserLabel2 = new JLabel("Select Role:   ");
        final JComboBox existingUserComboBox2 = new JComboBox();
        for(int i = 0; i < roles.length; i++)
            existingUserComboBox2.addItem(roles[i]);
        ...
        createUserPanel.add(createUserLabel2);
        createUserPanel.add(existingUserComboBox2);
    ...
    public void launchInterface(String name) {
        ...
        System.out.println("launchInterface(" + name + ") called.");
